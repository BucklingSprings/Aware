...
Namespace BucklingSprings.Aware.Entitities
    Public NotInheritable Partial Class SwitchToGenericClassificationScheme
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(SwitchToGenericClassificationScheme))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201210171901473_SwitchToGenericClassificationScheme"
            End Get
        End Property
