...
Namespace BucklingSprings.Aware.Entitities
    Public NotInheritable Partial Class SummariesIndex
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(SummariesIndex))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201210211826208_SummariesIndex"
            End Get
        End Property
