...
Namespace BucklingSprings.Aware.Entitities
    Public NotInheritable Partial Class CombineSamples
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(CombineSamples))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201211051944501_CombineSamples"
            End Get
        End Property
