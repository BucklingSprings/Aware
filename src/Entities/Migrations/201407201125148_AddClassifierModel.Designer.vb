...
Namespace BucklingSprings.Aware.Entitities
    Public NotInheritable Partial Class AddClassifierModel
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddClassifierModel))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201407201125148_AddClassifierModel"
            End Get
        End Property
