...
Namespace BucklingSprings.Aware.Entitities
    Public NotInheritable Partial Class AddIdleClassFlag
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddIdleClassFlag))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201210261727500_AddIdleClassFlag"
            End Get
        End Property
